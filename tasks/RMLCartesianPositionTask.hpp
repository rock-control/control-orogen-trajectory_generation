...
Position based implementation of a Cartesian RML task. The given target has to have valid position entries. Velocity entries are optional.
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','trajectory_generation::RMLCartesianPositionTask')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for RMLCartesianPositionTask
        ...
        /** Default deconstructor of RMLCartesianPositionTask
         */
